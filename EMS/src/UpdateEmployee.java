...
public class UpdateEmployee extends JFrame implements ActionListener 
{
    ...
    UpdateEmployee(String number){
        ...
        try {
            Conn c = new Conn();
            String query = "select * from employee2 where empId = '"+number+"'";
        ...
        updated.setBounds(450,550,150,40);
    ...
    //now acc to idno. we will take out our data frm db
    
    @Override
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == updated){
            ...
            try {
              Conn c = new Conn();
              String query = "update employee2 set fname = '"+fname+"', salary = '"+salary+"', address = '"+address+"', phone = '"+phone+"', email = '"+email+"', education = '"+education+"', designation = '"+designation+"' where empId = '"+number+"'";
